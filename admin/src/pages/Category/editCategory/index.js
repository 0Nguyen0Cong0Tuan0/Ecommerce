...
const EditCategory = () => {
    ...
    const editCategory = (e) => {
        ...
        // Ensure name and color are provided
        if (formFields.name !== "" && formFields.color !== "") {
            ...
            editData(`/api/category/${id}`, formData, {
                headers: {
    ...
    return (
        <>
            <div className={`flex flex-col ${mainBackgroundClass} p-10 min-h-[calc(100vh-84px)]`}>
                ...
                <form className={`rounded-lg p-8 ${modeGradientClass} flex-grow`} onSubmit={editCategory}>
                                        ...
                                        <div className="flex flex-wrap gap-4 mb-4">
                                            {previews.map((img, index) => (
                                                <div className="relative" key={index}>
                                                    {/* If img is a file object (newly uploaded), use URL.createObjectURL; otherwise, use img.url */}
                                                    <img
