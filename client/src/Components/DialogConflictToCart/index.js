...
const DialogConflictToCart = ({ product }) => {
    const context = useContext(MyContext);
    const navigate = useNavigate();

    const navigateToCart = () => {
        context.setIsOpenDialogConflictCart(false);
        navigate(`/cart`);
    };
    ...
    return (
        <Dialog
            open={context.isOpenDialogConflictCart}  // Use the correct state variable here
            ...
            <div className="bg-white shadow-xl rounded-lg max-w-lg w-full p-6">
                ...
                <DialogActions className="pt-4">
                    ...
                    <Button
                        ...
                        className="hover:bg-red-600"
                    >
                        <p className='text-white'>View My Cart ( {context.numberProductInCart} )</p>
                    </Button>
                </DialogActions>
            </div>
        </Dialog>
...
export default DialogConflictToCart;
