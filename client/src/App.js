  ...
  const App = () => {
    ...
    const values = {
      ...
      pageCategoryProduct,
      setPageCategoryProduct,
      itemsPerCategoryPage,
      setItemsPerCategoryPage,
      searchCategoryPageQuery,
      setSearchCategoryPageQuery,
      categoryPageSortBy,
      setCategoryPageSortBy,

      pageSubCategoryProduct,
      setPageSubCategoryProduct,
      itemsPerSubCategoryPage,
      setItemsPerSubCategoryPage,
      searchSubCategoryPageQuery,
      setSearchSubCategoryPageQuery,
      subCategoryPageSortBy,
      setSubCategoryPageSortBy,
    ...
    useEffect(() => {
      ...
      fetchFeaturedProducts(); // Call the async function
    ...
    //     setIsLoading(true); // Start loading
    //     try {
    //       const productQueryRes = await fetchDataFromApi(`/api/product?page=${page}&limit=${itemsPerPage}&search=${searchQuery}&sortBy=${sortBy}`);
    //       setProductData(productQueryRes);
    //     } catch (error) {
    //       console.error("Error fetching data:", error);
    //     } finally {
    //       setIsLoading(false); // Stop loading after fetching
